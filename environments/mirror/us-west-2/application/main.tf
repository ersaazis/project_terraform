module "vpc" {
  ...
  vpc_name            = "mirror-application-vpc"
  vpc_cidr             = "10.24.0.0/16"
  public_subnet_cidrs  = ["10.24.1.0/24"]
  private_subnet_cidrs = ["10.24.2.0/24"]
...
module "ec2" {
  ...
  instance_name    = "mirror-application-node"
  ...
  key_name             = "secret-key-mirror-app-us-west-2"
